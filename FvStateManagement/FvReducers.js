...
const FvCartReducer = (st = cart, action) => {
...
const FvUserReducer = (st = userState, action) => {
  switch (action.type) {
...
const FvCrntPrdtReducer = (state = crntPrdtState, action) => {
  switch (action.type) {
...
const FvToggleFav = (state = FavItems, action) => {
  switch (action.type) {
