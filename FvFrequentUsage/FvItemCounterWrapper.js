    ...
    <View
      ...
      {(position === 'top' || position === 'left') && (
        <DefaultCounter
          position={position}
          item={props.item}
          FvaddCart={(i) => props.FvaddCartAction(i)}
          FvremoveCart={(i) => props.FvremoveCartAction(i)}
  ...
  return (
    <View
      ...
      <View
        ...
        <TouchableOpacity onPress={() => FvremoveCart(item)}>
          <FontAwesome
            name="minus"
            size={H_W.width * 0.05}
        ...
        <TouchableOpacity onPress={() => FvaddCart(item)}>
          <FontAwesome
            name="plus"
            size={H_W.width * 0.05}
            color={counterContentColor ? counterContentColor : 'black'}
...
export default connect(null, {FvaddCartAction, FvremoveCartAction})(
  ItemCounterWrapper,
);
